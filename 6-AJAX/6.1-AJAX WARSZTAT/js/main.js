...
onSuccess: function(data) {
    ...
    // // ES5
    // paragraf.innerHTML = "Id: " + pierwszyUzytkownik.id + "<br>" + " name: " + pierwszyUzytkownik.name + "<br>" + " e-mail: " + pierwszyUzytkownik.email + "<br>" + " website: " + pierwszyUzytkownik.website + "<br>" + "phone:" + pierwszyUzytkownik.phone
